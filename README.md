# Hi, I’m **Shubham Golghate** 👋

**Product Manager @ Booking.com**, with a strong passion for **Fintech**, **Payments**, and **AI-driven experiences**. :contentReference[oaicite:0]{index=0}  
I bring product strategy + execution experience, and I love building lean, impactful tools to solve real problems.
...
- **Product Strategy** — defining product roadmaps, aligning with stakeholders  
- **Analytics & Data** — leveraging data to make decisions, run experiments  
- **AI & Automation** — building or mentoring on AI-led workflows  
- **Cross-functional Collaboration** — working with engineering, design, and data teams
